...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, reset_n, m_axis_data, m_axis_valid, 
  m_axis_ready, s_axis_data, s_axis_valid, s_axis_ready)
/* synthesis syn_black_box black_box_pad_pin="clk,reset_n,m_axis_data[31:0],m_axis_valid,m_axis_ready,s_axis_data[31:0],s_axis_valid,s_axis_ready" */;
  input clk;
  input reset_n;
