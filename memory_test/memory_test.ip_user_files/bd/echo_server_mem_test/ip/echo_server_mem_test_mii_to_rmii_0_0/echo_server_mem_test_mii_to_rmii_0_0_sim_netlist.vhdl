...
--               /home/jack/VERILOG/4_29_onward/memory_test_mig/memory_test/memory_test.gen/sources_1/bd/echo_server_mem_test/ip/echo_server_mem_test_mii_to_rmii_0_0/echo_server_mem_test_mii_to_rmii_0_0_sim_netlist.vhdl
...
entity echo_server_mem_test_mii_to_rmii_0_0_SRL_FIFO is
  port (
    D : out STD_LOGIC_VECTOR ( 0 to 0 );
    SR : out STD_LOGIC_VECTOR ( 0 to 0 );
    \RX_100_MBPS.fifo_ldr_ns\ : out STD_LOGIC_VECTOR ( 0 to 0 );
    ...
    \RX_100_MBPS.rx_end_packet\ : in STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of echo_server_mem_test_mii_to_rmii_0_0_SRL_FIFO : entity is "SRL_FIFO";
end echo_server_mem_test_mii_to_rmii_0_0_SRL_FIFO;

architecture STRUCTURE of echo_server_mem_test_mii_to_rmii_0_0_SRL_FIFO is
  ...
  signal \RX_100_MBPS.fIFO_Read__0\ : STD_LOGIC;
  signal \^rx_100_mbps.fifo_ldr_ns\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal S : STD_LOGIC;
...
begin
  D(0) <= \^d\(0);
  \RX_100_MBPS.fifo_ldr_ns\(0) <= \^rx_100_mbps.fifo_ldr_ns\(0);
  SR(0) <= \^sr\(0);
...
\Addr_Counters[0].MUXCY_L_I_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"6666666666666664"
        ...
        port map (
      I0 => \RX_100_MBPS.fIFO_Read__0\,
      I1 => \Addr_Counters[0].FDRE_I_n_0\,
      I2 => \Addr_Counters[1].FDRE_I_n_0\,
      I3 => \Addr_Counters[3].FDRE_I_n_0\,
      I4 => \Addr_Counters[2].FDRE_I_n_0\,
      I5 => \^rx_100_mbps.fifo_ldr_ns\(0),
      O => S
    );
\Addr_Counters[0].MUXCY_L_I_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAA2AAAAAAA"
        ...
        port map (
      I0 => \^rx_100_mbps.fifo_ldr_ns\(0),
      I1 => \Addr_Counters[0].FDRE_I_n_0\,
      I2 => \Addr_Counters[1].FDRE_I_n_0\,
      I3 => \Addr_Counters[3].FDRE_I_n_0\,
      I4 => \Addr_Counters[2].FDRE_I_n_0\,
      I5 => \RX_100_MBPS.fIFO_Read__0\,
      O => CI
    );
...
\FSM_sequential_RX_100_MBPS.fifo_ldr_cs[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I2 => \RX_100_MBPS.rx_end_packet\(0),
      I3 => \RX_100_MBPS.rx_end_packet\(1),
      O => \^rx_100_mbps.fifo_ldr_ns\(0)
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity echo_server_mem_test_mii_to_rmii_0_0_rmii_tx_fixed is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of echo_server_mem_test_mii_to_rmii_0_0_rmii_tx_fixed : entity is "rmii_tx_fixed";
end echo_server_mem_test_mii_to_rmii_0_0_rmii_tx_fixed;

architecture STRUCTURE of echo_server_mem_test_mii_to_rmii_0_0_rmii_tx_fixed is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity echo_server_mem_test_mii_to_rmii_0_0_rmii_rx_fixed is
  port (
    Reset : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of echo_server_mem_test_mii_to_rmii_0_0_rmii_rx_fixed : entity is "rmii_rx_fixed";
end echo_server_mem_test_mii_to_rmii_0_0_rmii_rx_fixed;

architecture STRUCTURE of echo_server_mem_test_mii_to_rmii_0_0_rmii_rx_fixed is
  ...
  signal \RX_100_MBPS.fIFO_Data_Exists\ : STD_LOGIC;
  signal \RX_100_MBPS.fifo_flshr_ns\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \RX_100_MBPS.fifo_ldr_cs\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \RX_100_MBPS.fifo_ldr_ns\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \RX_100_MBPS.phy2Rmii_crs_dv_d1\ : STD_LOGIC;
  signal \RX_100_MBPS.phy2Rmii_crs_dv_d2\ : STD_LOGIC;
  signal \RX_100_MBPS.phy2Rmii_crs_dv_d3\ : STD_LOGIC;
  signal \RX_100_MBPS.phy2Rmii_crs_dv_d4\ : STD_LOGIC;
  signal \RX_100_MBPS.rmii2Mac_crs_i0\ : STD_LOGIC;
  signal \RX_100_MBPS.rmii2Mac_rx_er_d1\ : STD_LOGIC;
  signal \RX_100_MBPS.rmii2Mac_rx_er_d2\ : STD_LOGIC;
  signal \RX_100_MBPS.rmii2Mac_rx_er_d3\ : STD_LOGIC;
  ...
  signal \RX_100_MBPS.rx_begin_packet_reg_n_0_[1]\ : STD_LOGIC;
  signal \RX_100_MBPS.rx_end_packet\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \RX_100_MBPS.rx_end_packet[0]_i_1_n_0\ : STD_LOGIC;
  signal \RX_100_MBPS.rx_end_packet[1]_i_1_n_0\ : STD_LOGIC;
  signal \RX_100_MBPS.rx_out_mux_sel\ : STD_LOGIC;
...
\FSM_sequential_RX_100_MBPS.fifo_flshr_cs_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => ref_clk,
      CE => '1',
      D => \RX_100_MBPS.fIFO_Data_Exists\,
      Q => \RX_100_MBPS.rx_out_mux_sel\,
      R => \^reset\
    );
\FSM_sequential_RX_100_MBPS.fifo_ldr_cs[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000000F4F404F4"
        ...
        port map (
      I0 => \RX_100_MBPS.rx_begin_packet_reg_n_0_[1]\,
      I1 => p_1_in(1),
      I2 => \RX_100_MBPS.fifo_ldr_cs\(1),
      I3 => \RX_100_MBPS.rx_end_packet\(0),
      I4 => \RX_100_MBPS.rx_end_packet\(1),
      I5 => \RX_100_MBPS.fifo_ldr_cs\(0),
      O => \RX_100_MBPS.fifo_ldr_ns\(0)
    );
\FSM_sequential_RX_100_MBPS.fifo_ldr_cs_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => ref_clk,
      CE => '1',
      D => \RX_100_MBPS.fifo_ldr_ns\(0),
      Q => \RX_100_MBPS.fifo_ldr_cs\(0),
      R => \^reset\
    );
\FSM_sequential_RX_100_MBPS.fifo_ldr_cs_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => ref_clk,
      CE => '1',
      D => \RX_100_MBPS.fifo_ldr_ns\(1),
      Q => \RX_100_MBPS.fifo_ldr_cs\(1),
      R => \^reset\
    );
\RX_100_MBPS.I_SRL_FIFO\: entity work.echo_server_mem_test_mii_to_rmii_0_0_SRL_FIFO
     port map (
      \Addr_Counters[3].FDRE_I_0\(0) => \Addr_Counters[3].FDRE_I\(0),
      D(0) => \RX_100_MBPS.fIFO_Data_Exists\,
      Data_In(3) => Data_In(1),
      Data_In(2) => Data_In(2),
      Data_In(1) => Data_In(3),
      Data_In(0) => Data_In(4),
      ...
      \FSM_sequential_RX_100_MBPS.fifo_ldr_cs_reg[1]\(1 downto 0) => \RX_100_MBPS.fifo_ldr_cs\(1 downto 0),
      Q(1) => \RX_100_MBPS.rx_out_mux_sel\,
      Q(0) => \^q\(0),
      \RX_100_MBPS.fifo_ldr_ns\(0) => \RX_100_MBPS.fifo_ldr_ns\(1),
      \RX_100_MBPS.rx_end_packet\(1 downto 0) => \RX_100_MBPS.rx_end_packet\(1 downto 0),
      SR(0) => \^reset\,
      ref_clk => ref_clk
    );
...
\RX_100_MBPS.Rmii2Mac_rx_er_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"C0A000A0"
        ...
        port map (
      I0 => \^rmii2mac_rx_er\,
      I1 => \RX_100_MBPS.rmii2Mac_rx_er_d3\,
      I2 => \Addr_Counters[3].FDRE_I\(0),
      I3 => \^q\(0),
      I4 => \RX_100_MBPS.rx_out_mux_sel\,
...
\RX_100_MBPS.phy2Rmii_crs_dv_d1_reg\: unisim.vcomponents.FDRE
     port map (
      ...
      Q => \RX_100_MBPS.phy2Rmii_crs_dv_d1\,
      R => \^reset\
    );
\RX_100_MBPS.phy2Rmii_crs_dv_d2_reg\: unisim.vcomponents.FDRE
     port map (
      C => ref_clk,
      CE => '1',
      D => \RX_100_MBPS.phy2Rmii_crs_dv_d1\,
      Q => \RX_100_MBPS.phy2Rmii_crs_dv_d2\,
      R => \^reset\
    );
\RX_100_MBPS.phy2Rmii_crs_dv_d3_reg\: unisim.vcomponents.FDRE
     port map (
      C => ref_clk,
      CE => '1',
      D => \RX_100_MBPS.phy2Rmii_crs_dv_d2\,
      Q => \RX_100_MBPS.phy2Rmii_crs_dv_d3\,
      R => \^reset\
    );
\RX_100_MBPS.phy2Rmii_crs_dv_d4_reg\: unisim.vcomponents.FDRE
     port map (
      C => ref_clk,
      CE => '1',
      D => \RX_100_MBPS.phy2Rmii_crs_dv_d3\,
      Q => \RX_100_MBPS.phy2Rmii_crs_dv_d4\,
      R => \^reset\
    );
...
\RX_100_MBPS.rmii2Mac_crs_i_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B0"
        ...
        port map (
      I0 => \^rmii2mac_crs_i\,
      I1 => \RX_100_MBPS.phy2Rmii_crs_dv_d4\,
      I2 => \RX_100_MBPS.phy2Rmii_crs_dv_d2\,
      O => \RX_100_MBPS.rmii2Mac_crs_i0\
    );
\RX_100_MBPS.rmii2Mac_crs_i_reg\: unisim.vcomponents.FDRE
     port map (
      C => ref_clk,
      CE => '1',
      D => \RX_100_MBPS.rmii2Mac_crs_i0\,
      Q => \^rmii2mac_crs_i\,
      R => \^reset\
    );
\RX_100_MBPS.rmii2Mac_rx_er_d1_reg\: unisim.vcomponents.FDRE
     port map (
      ...
      CE => '1',
      D => phy2Rmii_rx_er_d2,
      Q => \RX_100_MBPS.rmii2Mac_rx_er_d1\,
      R => \^reset\
    );
\RX_100_MBPS.rmii2Mac_rx_er_d2_reg\: unisim.vcomponents.FDRE
     port map (
      C => ref_clk,
      CE => '1',
      D => \RX_100_MBPS.rmii2Mac_rx_er_d1\,
      Q => \RX_100_MBPS.rmii2Mac_rx_er_d2\,
      R => \^reset\
    );
\RX_100_MBPS.rmii2Mac_rx_er_d3_reg\: unisim.vcomponents.FDRE
     port map (
      C => ref_clk,
      CE => '1',
      D => \RX_100_MBPS.rmii2Mac_rx_er_d2\,
      Q => \RX_100_MBPS.rmii2Mac_rx_er_d3\,
      R => \^reset\
    );
\RX_100_MBPS.rx_begin_packet[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000AAEA"
        ...
        port map (
      I0 => p_1_in(1),
      I1 => \RX_100_MBPS.phy2Rmii_crs_dv_d2\,
      I2 => L(2),
      I3 => L(3),
...
\RX_100_MBPS.rx_begin_packet[0]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"4F"
        ...
        port map (
      I0 => \RX_100_MBPS.rx_end_packet\(1),
      I1 => \RX_100_MBPS.rx_end_packet\(0),
      I2 => \Addr_Counters[3].FDRE_I\(0),
...
\RX_100_MBPS.rx_begin_packet_reg[1]\: unisim.vcomponents.FDRE
     port map (
      ...
      Q => \RX_100_MBPS.rx_begin_packet_reg_n_0_[1]\,
      R => '0'
    );
\RX_100_MBPS.rx_end_packet[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"D0D0D0DD00000000"
        ...
        port map (
      I0 => p_1_in(1),
      I1 => \RX_100_MBPS.rx_begin_packet_reg_n_0_[1]\,
      I2 => \RX_100_MBPS.rx_end_packet\(0),
      I3 => \RX_100_MBPS.phy2Rmii_crs_dv_d3\,
      I4 => \RX_100_MBPS.phy2Rmii_crs_dv_d2\,
...
\RX_100_MBPS.rx_end_packet[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8808"
        ...
        port map (
      I0 => \RX_100_MBPS.rx_end_packet\(0),
      I1 => \Addr_Counters[3].FDRE_I\(0),
      I2 => p_1_in(1),
      I3 => \RX_100_MBPS.rx_begin_packet_reg_n_0_[1]\,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity echo_server_mem_test_mii_to_rmii_0_0_mii_to_rmii is
  port (
    rst_n : in STD_LOGIC;
    ref_clk : in STD_LOGIC;
  ...
  attribute C_FAMILY of echo_server_mem_test_mii_to_rmii_0_0_mii_to_rmii : entity is "artix7";
  attribute C_FIXED_SPEED : string;
  attribute C_FIXED_SPEED of echo_server_mem_test_mii_to_rmii_0_0_mii_to_rmii : entity is "1'b1";
  attribute C_INCLUDE_BUF : integer;
  attribute C_INCLUDE_BUF of echo_server_mem_test_mii_to_rmii_0_0_mii_to_rmii : entity is 0;
  attribute C_INSTANCE : string;
  attribute C_INSTANCE of echo_server_mem_test_mii_to_rmii_0_0_mii_to_rmii : entity is "echo_server_mem_test_mii_to_rmii_0_0";
  attribute C_SPEED_100 : string;
  attribute C_SPEED_100 of echo_server_mem_test_mii_to_rmii_0_0_mii_to_rmii : entity is "1'b1";
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of echo_server_mem_test_mii_to_rmii_0_0_mii_to_rmii : entity is "mii_to_rmii";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of echo_server_mem_test_mii_to_rmii_0_0_mii_to_rmii : entity is "yes";
  attribute hdl : string;
  attribute hdl of echo_server_mem_test_mii_to_rmii_0_0_mii_to_rmii : entity is "VHDL";
  attribute imp_netlist : string;
  attribute imp_netlist of echo_server_mem_test_mii_to_rmii_0_0_mii_to_rmii : entity is "TRUE";
  attribute ip_group : string;
  attribute ip_group of echo_server_mem_test_mii_to_rmii_0_0_mii_to_rmii : entity is "LOGICORE";
  attribute iptype : string;
  attribute iptype of echo_server_mem_test_mii_to_rmii_0_0_mii_to_rmii : entity is "IP";
  attribute style : string;
  attribute style of echo_server_mem_test_mii_to_rmii_0_0_mii_to_rmii : entity is "HDL";
end echo_server_mem_test_mii_to_rmii_0_0_mii_to_rmii;

architecture STRUCTURE of echo_server_mem_test_mii_to_rmii_0_0_mii_to_rmii is
...
begin
\RMII_FIXED.I_RX\: entity work.echo_server_mem_test_mii_to_rmii_0_0_rmii_rx_fixed
     port map (
...
\RMII_FIXED.I_TX\: entity work.echo_server_mem_test_mii_to_rmii_0_0_rmii_tx_fixed
     port map (
...
entity echo_server_mem_test_mii_to_rmii_0_0 is
  ...
  attribute NotValidForBitStream of echo_server_mem_test_mii_to_rmii_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of echo_server_mem_test_mii_to_rmii_0_0 : entity is "echo_server_mem_test_mii_to_rmii_0_0,mii_to_rmii,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of echo_server_mem_test_mii_to_rmii_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of echo_server_mem_test_mii_to_rmii_0_0 : entity is "mii_to_rmii,Vivado 2022.1";
end echo_server_mem_test_mii_to_rmii_0_0;

architecture STRUCTURE of echo_server_mem_test_mii_to_rmii_0_0 is
  attribute C_FAMILY : string;
  ...
  attribute C_INSTANCE : string;
  attribute C_INSTANCE of U0 : label is "echo_server_mem_test_mii_to_rmii_0_0";
  attribute C_SPEED_100 : string;
  ...
  attribute x_interface_parameter of ref_clk : signal is "XIL_INTERFACENAME clock, BOARD.ASSOCIATED_PARAM REF_CLK_BOARD_INTERFACE, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /clk_wiz_1_clk_out1, INSERT_VIP 0";
...
begin
U0: entity work.echo_server_mem_test_mii_to_rmii_0_0_mii_to_rmii
     port map (
